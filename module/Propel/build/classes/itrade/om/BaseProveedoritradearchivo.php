...
/**
 * Base class that represents a row from the 'proveedoritradearchivo' table.
 *
 *
 *
 * @package    propel.generator.itrade.om
 */
abstract class BaseProveedoritradearchivo extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProveedoritradearchivoPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProveedoritradearchivoPeer
     */
    ...
    /**
     * The value for the idproveedoritradearchivo field.
     * @var        int
     */
    protected $idproveedoritradearchivo;
    ...
    /**
     * The value for the proveedoritradearchivo_archivo field.
     * @var        string
     */
    ...
    /**
     * Get the [idproveedoritradearchivo] column value.
     *
     * @return int
     */
    public function getIdproveedoritradearchivo()
    {

        return $this->idproveedoritradearchivo;
    }
    ...
    /**
     * Get the [proveedoritradearchivo_archivo] column value.
     *
     * @return string
     */
    public function getProveedoritradearchivoArchivo()
    {
    ...
    /**
     * Set the value of [idproveedoritradearchivo] column.
     *
     * @param  int $v new value
     * @return Proveedoritradearchivo The current object (for fluent API support)
     */
    public function setIdproveedoritradearchivo($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idproveedoritradearchivo !== $v) {
            $this->idproveedoritradearchivo = $v;
            $this->modifiedColumns[] = ProveedoritradearchivoPeer::IDPROVEEDORITRADEARCHIVO;
        }


        return $this;
    } // setIdproveedoritradearchivo()
    ...
    public function setIdproveedoritrade($v)
    {
        ...
        if ($this->idproveedoritrade !== $v) {
            ...
            $this->modifiedColumns[] = ProveedoritradearchivoPeer::IDPROVEEDORITRADE;
        }
    ...
    /**
     * Set the value of [proveedoritradearchivo_archivo] column.
     *
     * @param  string $v new value
     * @return Proveedoritradearchivo The current object (for fluent API support)
     */
    public function setProveedoritradearchivoArchivo($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->proveedoritradearchivo_archivo !== $v) {
            $this->proveedoritradearchivo_archivo = $v;
            $this->modifiedColumns[] = ProveedoritradearchivoPeer::PROVEEDORITRADEARCHIVO_ARCHIVO;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProveedoritradearchivoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProveedoritradearchivoQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProveedoritradearchivoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProveedoritradearchivoPeer::IDPROVEEDORITRADEARCHIVO)) {
            $modifiedColumns[':p' . $index++]  = '`idproveedoritradearchivo`';
        }
        if ($this->isColumnModified(ProveedoritradearchivoPeer::IDPROVEEDORITRADE)) {
        ...
        $sql = sprintf(
            'INSERT INTO `proveedoritradearchivo` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idproveedoritradearchivo`':
                        $stmt->bindValue($identifier, $this->idproveedoritradearchivo, PDO::PARAM_INT);
                        break;
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProveedoritradearchivoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProveedoritradearchivoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdproveedoritradearchivo();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['Proveedoritradearchivo'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Proveedoritradearchivo'][$this->getPrimaryKey()] = true;
        $keys = ProveedoritradearchivoPeer::getFieldNames($keyType);
        $result = array(
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdproveedoritradearchivo($value);
                break;
            case 1:
    ...
    {
        $criteria = new Criteria(ProveedoritradearchivoPeer::DATABASE_NAME);
        $criteria->add(ProveedoritradearchivoPeer::IDPROVEEDORITRADEARCHIVO, $this->idproveedoritradearchivo);
    ...
    /**
     * Generic method to set the primary key (idproveedoritradearchivo column).
     *
    ...
    {
        $this->setIdproveedoritradearchivo($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdproveedoritradearchivo();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Proveedoritradearchivo (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdproveedoritradearchivo(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Proveedoritradearchivo Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProveedoritradearchivoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProveedoritradearchivoPeer();
        }
    ...
    public function setProveedoritrade(Proveedoritrade $v = null)
    {
        ...
        if ($v !== null) {
            $v->addProveedoritradearchivo($this);
        }
    ...
    {
        return (string) $this->exportTo(ProveedoritradearchivoPeer::DEFAULT_STRING_FORMAT);
    }
