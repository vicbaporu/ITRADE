...
/**
 * Base class that represents a row from the 'expedientehistorial' table.
 *
 *
 *
 * @package    propel.generator.itrade.om
 */
abstract class BaseExpedientehistorial extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ExpedientehistorialPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ExpedientehistorialPeer
     */
    ...
    /**
     * The value for the idexpedientehistorial field.
     * @var        int
     */
     ...
     * @var        int
     */
    protected $idestadoservicio;

    /**
     * The value for the expedientehistorial_fecha field.
     * @var        string
     */
    protected $expedientehistorial_fecha;

    /**
     * The value for the expedientehistorial_nota field.
     * @var        string
     */
    ...
    /**
     * Get the [idexpedientehistorial] column value.
     *
     * @return int
     */
    public function getIdexpedientehistorial()
    {

        return $this->idexpedientehistorial;
    }
    ...
    /**
     * Get the [idestadoservicio] column value.
     *
     * @return int
     */
    ...
    /**
     * Get the [optionally formatted] temporal [expedientehistorial_fecha] column value.
     *
     *
     ...
     */
    public function getExpedientehistorialFecha($format = 'Y-m-d H:i:s')
    {
        if ($this->expedientehistorial_fecha === null) {
            return null;
        }

        if ($this->expedientehistorial_fecha === '0000-00-00 00:00:00') {
        ...
        try {
            $dt = new DateTime($this->expedientehistorial_fecha);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->expedientehistorial_fecha, true), $x);
        }
    ...
    /**
     * Get the [expedientehistorial_nota] column value.
     *
     * @return string
     */
    public function getExpedientehistorialNota()
    {

        return $this->expedientehistorial_nota;
    }

    /**
     * Set the value of [idexpedientehistorial] column.
     *
     * @param  int $v new value
     * @return Expedientehistorial The current object (for fluent API support)
     */
    public function setIdexpedientehistorial($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idexpedientehistorial !== $v) {
            $this->idexpedientehistorial = $v;
     ...
     * @return Expedientehistorial The current object (for fluent API support)
     */
    public function setIdestadoservicio($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idestadoservicio !== $v) {
            $this->idestadoservicio = $v;
            $this->modifiedColumns[] = ExpedientehistorialPeer::IDESTADOSERVICIO;
        }

        if ($this->aServicioestado !== null && $this->aServicioestado->getIdservicioestado() !== $v) {
    ...
    public function setExpedientehistorialFecha($v)
    {
        ...
        return $this;
    } // setExpedientehistorialFecha()

    /**
     * Set the value of [expedientehistorial_nota] column.
     *
     * @param  string $v new value
     * @return Expedientehistorial The current object (for fluent API support)
     */
    public function setExpedientehistorialNota($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->expedientehistorial_nota !== $v) {
            $this->expedientehistorial_nota = $v;
            $this->modifiedColumns[] = ExpedientehistorialPeer::EXPEDIENTEHISTORIAL_NOTA;
        }


        return $this;
    } // setExpedientehistorialNota()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = ExpedientehistorialPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Expedientehistorial object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ExpedientehistorialPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ExpedientehistorialQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ExpedientehistorialPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO `expedientehistorial` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ExpedientehistorialPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ExpedientehistorialPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                return $this->getExpedientehistorialFecha();
                break;
            case 4:
                return $this->getExpedientehistorialNota();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['Expedientehistorial'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Expedientehistorial'][$this->getPrimaryKey()] = true;
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 2:
                ...
                break;
            case 3:
                $this->setExpedientehistorialFecha($value);
                break;
            case 4:
                $this->setExpedientehistorialNota($value);
                break;
        } // switch()
    }
    ...
    {
        $criteria = new Criteria(ExpedientehistorialPeer::DATABASE_NAME);
        $criteria->add(ExpedientehistorialPeer::IDEXPEDIENTEHISTORIAL, $this->idexpedientehistorial);
    ...
    /**
     * Generic method to set the primary key (idexpedientehistorial column).
     *
    ...
    {
        $this->setIdexpedientehistorial($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdexpedientehistorial();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Expedientehistorial (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdexpedientehistorial(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Expedientehistorial Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ExpedientehistorialPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ExpedientehistorialPeer();
        }
    ...
    {
        return (string) $this->exportTo(ExpedientehistorialPeer::DEFAULT_STRING_FORMAT);
    }
