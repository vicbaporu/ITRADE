...
/**
 * Base class that represents a row from the 'proveedoritradeservicio' table.
 *
 *
 *
 * @package    propel.generator.itrade_system.om
 */
abstract class BaseProveedoritradeservicio extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ProveedoritradeservicioPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ProveedoritradeservicioPeer
     */
    ...
    /**
     * The value for the idproveedoritradeservicio field.
     * @var        int
     */
    protected $idproveedoritradeservicio;
    ...
    /**
     * Get the [idproveedoritradeservicio] column value.
     *
     * @return int
     */
    public function getIdproveedoritradeservicio()
    {

        return $this->idproveedoritradeservicio;
    }
    ...
    /**
     * Set the value of [idproveedoritradeservicio] column.
     *
     * @param  int $v new value
     * @return Proveedoritradeservicio The current object (for fluent API support)
     */
    public function setIdproveedoritradeservicio($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idproveedoritradeservicio !== $v) {
            $this->idproveedoritradeservicio = $v;
            $this->modifiedColumns[] = ProveedoritradeservicioPeer::IDPROVEEDORITRADESERVICIO;
        }


        return $this;
    } // setIdproveedoritradeservicio()
    ...
    public function setIdproveedoritrade($v)
    {
        ...
        if ($this->idproveedoritrade !== $v) {
            ...
            $this->modifiedColumns[] = ProveedoritradeservicioPeer::IDPROVEEDORITRADE;
        }
    ...
    public function setIdservicio($v)
    {
        ...
        if ($this->idservicio !== $v) {
            $this->idservicio = $v;
            $this->modifiedColumns[] = ProveedoritradeservicioPeer::IDSERVICIO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->idproveedoritradeservicio = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
            ...
            return $startcol + 3; // 3 = ProveedoritradeservicioPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Proveedoritradeservicio object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProveedoritradeservicioPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProveedoritradeservicioQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ProveedoritradeservicioPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ProveedoritradeservicioPeer::IDPROVEEDORITRADESERVICIO;
        if (null !== $this->idproveedoritradeservicio) {
        ...
        if ($this->isColumnModified(ProveedoritradeservicioPeer::IDPROVEEDORITRADESERVICIO)) {
            $modifiedColumns[':p' . $index++]  = '`idproveedoritradeservicio`';
        }
        if ($this->isColumnModified(ProveedoritradeservicioPeer::IDPROVEEDORITRADE)) {
            $modifiedColumns[':p' . $index++]  = '`idproveedoritrade`';
        }
        if ($this->isColumnModified(ProveedoritradeservicioPeer::IDSERVICIO)) {
            $modifiedColumns[':p' . $index++]  = '`idservicio`';
        }

        $sql = sprintf(
            'INSERT INTO `proveedoritradeservicio` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idproveedoritradeservicio`':
                        $stmt->bindValue($identifier, $this->idproveedoritradeservicio, PDO::PARAM_INT);
                        break;
        ...
        $this->setIdproveedoritradeservicio($pk);
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ProveedoritradeservicioPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ProveedoritradeservicioPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdproveedoritradeservicio();
                break;
            case 1:
    ...
    {
        if (isset($alreadyDumpedObjects['Proveedoritradeservicio'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Proveedoritradeservicio'][$this->getPrimaryKey()] = true;
        $keys = ProveedoritradeservicioPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIdproveedoritradeservicio(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdproveedoritradeservicio($value);
                break;
            case 1:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) $this->setIdproveedoritradeservicio($arr[$keys[0]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProveedoritradeservicioPeer::IDPROVEEDORITRADESERVICIO)) $criteria->add(ProveedoritradeservicioPeer::IDPROVEEDORITRADESERVICIO, $this->idproveedoritradeservicio);
        if ($this->isColumnModified(ProveedoritradeservicioPeer::IDPROVEEDORITRADE)) $criteria->add(ProveedoritradeservicioPeer::IDPROVEEDORITRADE, $this->idproveedoritrade);
        if ($this->isColumnModified(ProveedoritradeservicioPeer::IDSERVICIO)) $criteria->add(ProveedoritradeservicioPeer::IDSERVICIO, $this->idservicio);
    ...
    {
        $criteria = new Criteria(ProveedoritradeservicioPeer::DATABASE_NAME);
        $criteria->add(ProveedoritradeservicioPeer::IDPROVEEDORITRADESERVICIO, $this->idproveedoritradeservicio);
    ...
    /**
     * Generic method to set the primary key (idproveedoritradeservicio column).
     *
    ...
    {
        $this->setIdproveedoritradeservicio($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdproveedoritradeservicio();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Proveedoritradeservicio (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdproveedoritradeservicio(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Proveedoritradeservicio Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ProveedoritradeservicioPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ProveedoritradeservicioPeer();
        }
    ...
    public function setProveedoritrade(Proveedoritrade $v = null)
    {
        ...
        if ($v !== null) {
            $v->addProveedoritradeservicio($this);
        }
    ...
    public function getProveedoritrade(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aProveedoritrade === null && ($this->idproveedoritrade !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aProveedoritrade->addProveedoritradeservicios($this);
             */
        }
    ...
    public function getServicio(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aServicio === null && ($this->idservicio !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aServicio->addProveedoritradeservicios($this);
             */
        }
    ...
    {
        $this->idproveedoritradeservicio = null;
    ...
    {
        return (string) $this->exportTo(ProveedoritradeservicioPeer::DEFAULT_STRING_FORMAT);
    }
