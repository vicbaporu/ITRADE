...
/**
 * Base class that represents a row from the 'expedientearchivo' table.
 *
 *
 *
 * @package    propel.generator.itrade_system.om
 */
abstract class BaseExpedientearchivo extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ExpedientearchivoPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ExpedientearchivoPeer
     */
    ...
    /**
     * The value for the idexpedientearchivo field.
     * @var        int
     */
    protected $idexpedientearchivo;
    ...
    /**
     * Get the [idexpedientearchivo] column value.
     *
     * @return int
     */
    public function getIdexpedientearchivo()
    {

        return $this->idexpedientearchivo;
    }
     ...
     */
    public function getExpedientearchivoFecha($format = 'Y-m-d H:i:s')
    {
        if ($this->expedientearchivo_fecha === null) {
            return null;
        }

        if ($this->expedientearchivo_fecha === '0000-00-00 00:00:00') {
        ...
        try {
            $dt = new DateTime($this->expedientearchivo_fecha);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->expedientearchivo_fecha, true), $x);
        }
    ...
    /**
     * Set the value of [idexpedientearchivo] column.
     *
     * @param  int $v new value
     * @return Expedientearchivo The current object (for fluent API support)
     */
    public function setIdexpedientearchivo($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->idexpedientearchivo !== $v) {
            $this->idexpedientearchivo = $v;
            $this->modifiedColumns[] = ExpedientearchivoPeer::IDEXPEDIENTEARCHIVO;
        }


        return $this;
    } // setIdexpedientearchivo()
    ...
    public function setIdexpediente($v)
    {
        ...
        if ($this->idexpediente !== $v) {
            $this->idexpediente = $v;
            $this->modifiedColumns[] = ExpedientearchivoPeer::IDEXPEDIENTE;
        }
    ...
    public function setIdempleado($v)
    {
        ...
        if ($this->idempleado !== $v) {
            $this->idempleado = $v;
            $this->modifiedColumns[] = ExpedientearchivoPeer::IDEMPLEADO;
        }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ExpedientearchivoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ExpedientearchivoQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ExpedientearchivoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = ExpedientearchivoPeer::IDEXPEDIENTEARCHIVO;
        if (null !== $this->idexpedientearchivo) {
        ...
        if ($this->isColumnModified(ExpedientearchivoPeer::IDEXPEDIENTEARCHIVO)) {
            $modifiedColumns[':p' . $index++]  = '`idexpedientearchivo`';
        }
        ...
        $sql = sprintf(
            'INSERT INTO `expedientearchivo` (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`idexpedientearchivo`':
                        $stmt->bindValue($identifier, $this->idexpedientearchivo, PDO::PARAM_INT);
                        break;
                    case '`idexpediente`':
        ...
        $this->setIdexpedientearchivo($pk);
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ExpedientearchivoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ExpedientearchivoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                return $this->getIdexpedientearchivo();
                break;
            case 1:
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            case 0:
                $this->setIdexpedientearchivo($value);
                break;
            case 1:
    ...
    {
        $criteria = new Criteria(ExpedientearchivoPeer::DATABASE_NAME);
        $criteria->add(ExpedientearchivoPeer::IDEXPEDIENTEARCHIVO, $this->idexpedientearchivo);
    ...
    /**
     * Generic method to set the primary key (idexpedientearchivo column).
     *
    ...
    {
        $this->setIdexpedientearchivo($key);
    }
    ...
    public function isPrimaryKeyNull()
    {
        ...
        return null === $this->getIdexpedientearchivo();
    }
     ...
     * objects.
     *
     * @param object $copyObj An object of Expedientearchivo (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setIdexpedientearchivo(NULL); // this is a auto-increment column, so set to default value
        }
    }
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Expedientearchivo Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ExpedientearchivoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ExpedientearchivoPeer();
        }
    ...
    public function getEmpleado(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aEmpleado === null && ($this->idempleado !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aEmpleado->addExpedientearchivos($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ExpedientearchivoPeer::DEFAULT_STRING_FORMAT);
    }
