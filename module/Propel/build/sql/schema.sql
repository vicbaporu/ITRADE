...
(
    ...
    `idexpediente` INTEGER NOT NULL,
    `idempleado` INTEGER,
    `expedientearchivo_fecha` DATETIME,
    `expedientearchivo_tipo` enum('blawb','certificadoorigen','polizaseguro','facturamercancia','facturashipper','pedimento','packinglist','msds','eir','estimaciongastos','documentosaduanales','otro'),
    `expedientearchivo_archivo` TEXT NOT NULL,
    `expedientearchivo_size` TEXT NOT NULL,
